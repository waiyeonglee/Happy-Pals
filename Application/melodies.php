...
if ( ! isset($_SESSION['all_visited']) ) {
	$stmt = $pdo->prepare('UPDATE account_data SET music_visited = :visited WHERE hashed_username = :hu');
...
<link rel="stylesheet" href="Melodies.css" media="screen">
